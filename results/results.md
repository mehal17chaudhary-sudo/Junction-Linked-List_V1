...
| | JLI | Skip list |
|---|---|---|
| Given location (splice) | O(1) | O(1) expected |
| Including locate | O(log n) *amortized, conditional* | O(log n) expected |
| Delete, dissolution worst case | O(S + J + B) | — (no analogue) |
